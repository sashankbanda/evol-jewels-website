...
const quizQuestions = {
    1: { question: "Q1. What's the occasion today?", answers: { q1: ['Casual', 'Work', 'Party/Celebration'] } },
    2: { question: "Q2. Which accessory type is your focus?", answers: { q2: ['Necklace', 'Ring', 'Earring', 'Bracelet'] } },
    3: { question: "Q3. Pick an outfit style that speaks to your soul.", answers: { q3: ['Classic', 'Modern', 'Relaxed'] } },
